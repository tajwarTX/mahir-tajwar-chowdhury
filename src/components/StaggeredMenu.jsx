    ...
    >
      ...
      >
          ...
          {(() => {
            ...
            return arr.map((c, i) => (
              <div
                ...
                style={{
                  background: `rgba(255,255,255,0.${i + 1})`, // slightly increasing opacity per layer
        ...
        >
          <button
            ref={toggleBtnRef}
            className="sm-toggle cursor-target px-3 ml-auto relative inline-flex items-center bg-transparent border-0 cursor-pointer text-[#e9e9ef] text-sm font-light leading-none overflow-visible pointer-events-auto"
              ...
              {items && items.length ? (
                items.map((it, idx) => (
                  <li className="sm-panel-itemWrap relative overflow-hidden leading-none" key={it.label + idx}>
                    <a
                      className="sm-panel-item relative text-black font-orbitron text-[4rem] cursor-pointer leading-none tracking-[-2px] uppercase transition-[background,color] duration-150 ease-linear inline-block no-underline pr-[1.4em]"
                      href={it.link}
...
sition: absolute; top: 0; right: 0; width: 100vw; height: 100%;  background: rgba(255,255,255,0.02); backdrop-filter: blur(5px); -webkit-backdrop-filter: blur(5px); border: 1px solid rgba(255,255,255,0.04); display: flex; flex-direction: column; padding: 8em 4em 4em 4em; overflow-y: auto; z-index: 10; }
